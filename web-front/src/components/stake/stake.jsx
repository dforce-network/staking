      ...
      <div className={classes.root}>
        ...
        <div className={classes.overview}>
          <div className={classes.overviewField}>
            ...
            <Typography variant={'h2'} className={classes.overviewValue}>{pool.tokens[0].balance ? this.formatNumber(pool.tokens[0].balance,pool.tokens[0].decimals,4) : "0"}  {pool.tokens[0].symbol}</Typography>
          </div>
          <div className={classes.overviewField}>
            ...
            <Typography variant={'h2'} className={classes.overviewValue}>{pool.tokens[0].stakedBalance ? this.formatNumber(pool.tokens[0].stakedBalance,pool.tokens[0].decimals,4) : "0"} {pool.tokens[0].symbol}</Typography>
          </div>
